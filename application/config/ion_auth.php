...
$config['username']                   = 'username';          // You can use any unique column in your table as username column. The values in this column, alongside password, will be used for login purposes
...
$config['track_login_ip_address']     = TRUE;                // Track login attempts by IP Address, if FALSE will track based on username. (Default: TRUE)
...
/*
 ...
 | username_cookie_name Default: username
 */
$config['remember_cookie_name'] = 'remember_code';
$config['username_cookie_name'] = 'username';
 ...
 */
$config['use_ci_email'] = true; // Send Email using the builtin CI email class, if false it will return the code and the username
